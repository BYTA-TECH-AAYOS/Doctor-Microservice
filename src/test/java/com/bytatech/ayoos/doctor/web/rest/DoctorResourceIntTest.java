...
import com.bytatech.ayoos.doctor.DoctormicroserviceApp;
...
@SpringBootTest(classes = DoctormicroserviceApp.class)
public class DoctorResourceIntTest {
    ...
    public void createDoctor() throws Exception {
        ...
        assertThat(testDoctor.getLocation()).isEqualTo(DEFAULT_LOCATION);
    ...
    public void updateDoctor() throws Exception {
        ...
        assertThat(testDoctor.getLocation()).isEqualTo(UPDATED_LOCATION);

...
import { PaymentSettingsComponent } from 'app/entities/doctormicroservice/payment-settings/payment-settings.component';
...
describe('Component Tests', () => {
  describe('PaymentSettings Management Component', () => {
    let comp: PaymentSettingsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PaymentSettingsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.paymentSettings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

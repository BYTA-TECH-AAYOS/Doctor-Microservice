...
import { ContactInfoComponent } from 'app/entities/doctormicroservice/contact-info/contact-info.component';
...
describe('Component Tests', () => {
  describe('ContactInfo Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contactInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { ProfileInfoComponent } from 'app/entities/doctormicroservice/profile-info/profile-info.component';
...
describe('Component Tests', () => {
  describe('ProfileInfo Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.profileInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { DoctorSettingsComponent } from 'app/entities/doctormicroservice/doctor-settings/doctor-settings.component';
...
describe('Component Tests', () => {
  describe('DoctorSettings Management Component', () => {
    let comp: DoctorSettingsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DoctorSettingsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.doctorSettings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
export class ContactInfoComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.contactInfoService
        ...
        .subscribe(
          (res: HttpResponse<IContactInfo[]>) => this.paginateContactInfos(res.body, res.headers),
  ...
  trackId(index: number, item: IContactInfo) {
    return item.id;
  }
  ...
  private paginateContactInfos(data: IContactInfo[], headers: HttpHeaders) {
